    ...
    return (
        <div className=''>
            <div className='shadow-lg p-10 rounded-md'>
                <Link to="/" className='shadow-md rounded-full p-3 hover:shadow-lg flex items-center justify-center gap-2 cursor-pointer'>
                ...
                <Link to='/analysis' className='shadow-md rounded-full p-3 mt-5 hover:shadow-lg flex items-center justify-center gap-2 cursor-pointer'>
